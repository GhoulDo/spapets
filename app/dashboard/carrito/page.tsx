...
import { ShoppingCart, Trash2, Plus, Minus, CreditCard, ArrowLeft, FileText, Loader2 } from "lucide-react"
            ...
            <div className="lg:col-span-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Tienes {cart.items.length} productos en tu carrito</CardDescription>
                </CardHeader>
